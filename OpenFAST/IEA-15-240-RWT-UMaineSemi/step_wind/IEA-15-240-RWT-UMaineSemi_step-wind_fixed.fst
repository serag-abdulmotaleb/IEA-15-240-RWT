...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-UMaineSemi_ElastoDyn_step-wind_fixed.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-15-240-RWT-UMaineSemi_Inflow_step-wind_fixed.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
