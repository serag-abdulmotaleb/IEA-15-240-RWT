...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-UMaineSemi_NoPS_ElastoDyn_step-wind_floating.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-15-240-RWT-UMaineSemi_NoPS_Inflow_step-wind_floating.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"..\IEA-15-240-RWT-UMaineSemi_AeroDyn15.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"..\IEA-15-240-RWT-UMaineSemi_ServoDyn_NoPS.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
